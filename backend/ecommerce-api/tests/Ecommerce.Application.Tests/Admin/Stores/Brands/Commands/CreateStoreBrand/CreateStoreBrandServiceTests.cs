...
namespace Ecommerce.Application.Tests.Admin.Stores.Brands.Commands.CreateStoreBrand
{
    public sealed class CreateStoreBrandServiceTests
    {
            ...
            CreateStoreBrandService service)
        {
            ...
            var expectedNormalizedName = IdentityNormalizer.Normalize(request.StoreBrandName);
            repositoryMock
